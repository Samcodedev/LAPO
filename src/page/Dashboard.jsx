  ...
  return (
    <div className="flex">
        ...
        <div className="flex-1 bg-[#F8FBFF]">
              ...
              SidebarSelected === 'Card Scheme' && (
                <div className="px-6 bg-gray-50 min-h-screen">
                  ...
                  <div className="mb-4">
                    ...
                    <p className="text-gray-500 -mt-1 mb-2">Add, view and edit card schemes here.</p>
                  </div>
                  ...
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <button onClick={() => setIsModalOpen(true)} className="bg-[#014DAF] text-white px-4 py-2 rounded-md flex items-center gap-2 hover:bg-[#014DAF] cursor-pointer">
                      <FiPlus /> Add Scheme
                    </button>
                  </div>
                  ...
                  <div className="bg-white rounded-sm overflow-hidden">
                    <table className="w-full border-collapse">
                      <thead className="bg-[#F9FAFB] font-extralight text-[#475467] border border-[#EAECF0] text-left">
                        <tr>
                          <th className="p-3 border-r border-[#EAECF0]">Scheme Name</th>
                          <th className="p-3 border-r border-[#EAECF0]">PAN Length</th>
                      ...
                      <tbody>
                        {data.map((row, index) => (
                          <tr key={index} className="border border-[#EAECF0]">
                            <td className="p-3 border-r border-[#EAECF0]">{row.scheme}</td>
                            <td className="p-3 border-r border-[#EAECF0]">{row.panLength}</td>
            ...
            <CardSchemeModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} />
